...
class CharlotteSocietyTabRight extends ConsumerStatefulWidget {
  const CharlotteSocietyTabRight({super.key});

  @override
  ConsumerState createState() => _CharlotteProductionTabRightState();
}

class _CharlotteProductionTabRightState extends ConsumerState<CharlotteSocietyTabRight> {
  @override
