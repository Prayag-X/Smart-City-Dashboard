        ...
        PieChartData(
            ...
            sections: widget.headers
                .map((header) => PieChartSectionData(
                      color: chartColors[widget.headers.indexOf(header)],
                      value: widget.percentages[widget.headers.indexOf(header)],
                      title:
                          '${widget.percentages[widget.headers.indexOf(header)].toStringAsFixed(0)}%',
                      showTitle:
                          widget.percentages[widget.headers.indexOf(header)] > 3
                              ? true
                              : false,
                            ...
                            .map(
                              (header) => Padding(
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                      width: Const.dashboardChartTextSize - 4,
                                      height: Const.dashboardChartTextSize - 4,
                                      decoration: BoxDecoration(
                                          color: chartColors[widget.headers.indexOf(header)],
                                          borderRadius:
                                    ...
                                    Text(
                                      ...
                                      style: textStyleNormal.copyWith(
                                          fontSize:
                                              Const.dashboardChartTextSize - 1,
                                          color: chartColors[widget.headers.indexOf(header)]),
                                    ),
                                  ],
                                ),
